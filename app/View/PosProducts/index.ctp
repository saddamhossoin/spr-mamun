  ...
  <div class="tDiv2">
   <?php echo $this->Form->create('PosProduct',array('controller' => 'posProducts','action'=>'index' ));?>
    ...
    <?php echo $this->Form->label('PosProduct.box_no', __('Box No'.': <span class="star"></span>', true) ); ?>
 	<?php echo $this->Form->input('PosProduct.box_no',array('type'=>'text','div'=>false,'label'=>false, 'size'=>25 ));?>
      ...
      <thead>
        ...
        <tr>
 		   <th align="left" width="5%"><?php echo "Image";?></th>
 			...
 			<th align="left" width="11%"><?php echo $this->Paginator->sort('PosPcategory.name','Category');?></th>
 			<th align="left" width="11%"><?php echo $this->Paginator->sort('PosBrand.name','Brand');?></th>
...
if(!empty($posProducts)){
	...
	<tr id='<?php echo 'row_'.$posProduct['PosProduct']['id'];?>'  <?php echo $class;?>>
		...
		<td align='left' class='alistname' width="11%"><?php echo  $posProduct['PosPcategory']['name']; ?>&nbsp;</td>			  
 		<td align='left' class='alistname' width="11%"><?php echo  $posProduct['PosBrand']['name']; ?>&nbsp;</td>
        <td align='left' class='alistname' width="7%"><?php echo $posProduct['PosProduct']['box_no']; ?>&nbsp;</td>
