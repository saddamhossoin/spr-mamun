...
<div>
    ...
    <div class="rightpan">
    	<div class="header"><?=$compitableProductItem[0]['PosBrand']['name'];?></div>
                    ...
                    <?php 
                     ...
                     if(!empty($compitableProductItem)){?>
                           <?php foreach($compitableProductItem as $comProduct){  ?>      
                             ...
                             <div class="zoom">
                              <div class="small">
			 					<?php  echo $this->Html->image('../'.$comProduct['PosProduct']['image'], array("alt" => "No Image","border"=>"0" ));?>
							</div>
                             <div class="large">
							 <?php  echo $this->Html->image('../'.$comProduct['PosProduct']['image'], array("alt" => "No Image","border"=>"0"  ));?>
							</div>
                               ...
                               <div class="description_grid">
                                <p>
								 ...
								 //  pr($comProduct);
									   ...
									   echo $comProduct['PosStock']['last_sales'] ."<span>(iva incl.)</span>";
