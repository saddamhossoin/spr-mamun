...
<?php echo $this->Form->create('PosCustomer');?>
	<?php	echo $this->Form->input('PosCustomer.id',array('div'=>false,'label'=>false,'class'=>'required'));
	echo $this->Form->input('PosCustomer.user_id',array('type'=>'hidden','div'=>false,'label'=>false,'class'=>''));
	?>
...
<div class="button_area">
		<?php echo $this->Form->button('Update',array( 'class'=>'submit', 'id'=>'btn_PosCustomer_edit'));?>
