    ...
    <table cellspacing="0" cellpadding="0">
       <thead>
        <tr>
			...
			<th align="left" width="8%" ><?php echo $this->Paginator->sort('customer_type');?></th>
 			<th align="left" width="20%"><?php echo $this->Paginator->sort('address');?></th>
			<th align="left" width="6%"><?php echo $this->Paginator->sort('mobile');?></th>
			<th align="left" width="18%"><?php echo $this->Paginator->sort('email');?></th>
 			<th align="left" width="12%"><?php echo $this->Paginator->sort('companyname','Company Name');?></th>
 			<th align="left" width="8%"><?php echo $this->Paginator->sort('telephone');?></th>
...
<?php
	...
	<tr id='<?php echo 'row_'.$posCustomer['PosCustomer']['id'];?>'  <?php echo $class;?>>
	 ...
	 <td align='left' width="8%"> <?php 
	 if(!empty($status[$posCustomer['PosCustomer']['customer_type']])){
	     echo $status[$posCustomer['PosCustomer']['customer_type']]; 
	 }?>&nbsp; </td>
	 <td align='left' width="20%"> <?php echo $posCustomer['PosCustomer']['address']; ?>&nbsp; </td>
	 <td align='left' width="6%"> <?php echo $posCustomer['PosCustomer']['mobile']; ?>&nbsp; </td>
	 <td align='left' width="18%"> <?php echo $posCustomer['PosCustomer']['email']; ?>&nbsp; </td>
	 <td align='left' width="12%"> <?php echo $posCustomer['PosCustomer']['companyname']; ?>&nbsp; </td>
 	 <td align='left'  width="8%"> <?php echo $posCustomer['PosCustomer']['tnt']; ?>&nbsp; </td>
