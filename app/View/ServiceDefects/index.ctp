  ...
  <div class="tDiv2">
   ...
   <?php echo $this->element('filter/commonfilter',array('cache' => array('time'=> '-7 days','key'=>'header')));?>
    <div class="button_area_filter">
      ...
      <?php echo $this->Form->button('Search',array( 'class'=>'submit', 'id'=>'btn_brand_search'));?>      <?php echo $this->Form->button('Reset',array('type'=>'reset','name'=>'reset','id'=>'Cancel','onClick'=>"parent.location='".$this->webroot."serviceDefects/index/yes'"));?>     
    </div>
    </form>
  </div>
...
<?php
	...
	foreach ($serviceDefects as $serviceDefect):
		...
		if ($i++ % 2 == 0) {
		 ...
		 $dataDate = date('d / m / Y',strtotime($serviceDefect['ServiceDefect']['created']));
	...
	?>
	<tr id='<?php echo 'row_'.$serviceDefect['ServiceDefect']['id'];?>'  <?php echo $class;?>>
		
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $serviceDefect['ServiceDefect']['name']; ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'>
		<?php if(h($serviceDefect['ServiceDefect']['status'])==1){echo "Active";	}else {	echo "Inactive";}?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'>
		<?php echo date("d/m/Y", strtotime($serviceDefect['ServiceDefect']['created'])); ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'>
		<?php echo date("d/m/Y", strtotime($serviceDefect['ServiceDefect']['modified'])); ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $userlists[$serviceDefect['ServiceDefect']['created_by']]; ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $userlists[$serviceDefect['ServiceDefect']['modified_by']]; ?>&nbsp;</div></td>
		<td class="actions">
<div style='width: 180px;' class='alistname link_link'>			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $serviceDefect['ServiceDefect']['id']),array('class'=>'link_view action_link')); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $serviceDefect['ServiceDefect']['id']),array('class'=>'link_edit action_link')); ?>
			<?php   echo $this->Html->link(__('Delete', true), array('action' => 'delete', $serviceDefect['ServiceDefect']['id']), array('class'=>'link_delete action_link'), sprintf(__('Are you sure you want to delete # %s?', true), $serviceDefect['ServiceDefect']['id'])); ?>
		</div></td>
	</tr>
<?php endforeach; ?>
    </table>
    ...
    <div class="pDiv">
    <div class="pGroup">
     	 <?php if($this->params['paging']['ServiceDefect']['prevPage']){?>
      ...
      <?php if($this->params['paging']['ServiceDefect']['nextPage']){?>
