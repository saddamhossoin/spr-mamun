...
<?php echo $this->Form->create('PosSaleReturnDetail');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperPosSaleReturnDetailId" class="microcontroll">
		<?php	echo $this->Form->label('PosSaleReturnDetail.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('PosSaleReturnDetail.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_PosSaleReturnDetail_edit'));?>
