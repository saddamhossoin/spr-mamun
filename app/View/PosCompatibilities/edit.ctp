...
<?php echo $this->Form->create('PosCompatibility');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperPosCompatibilityId" class="microcontroll">
		<?php	echo $this->Form->label('PosCompatibility.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('PosCompatibility.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_PosCompatibility_edit'));?>
