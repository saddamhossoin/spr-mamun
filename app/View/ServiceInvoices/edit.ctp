...
<?php echo $this->Form->create('ServiceInvoice');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperServiceInvoiceId" class="microcontroll">
		<?php	echo $this->Form->label('ServiceInvoice.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('ServiceInvoice.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>

		<div id="WrapperServiceInvoiceServiceDeviceInfoId" class="microcontroll">
		<?php	echo $this->Form->label('ServiceInvoice.service_device_info_id', __('Service Device Info Id'.':<span class=star>*</span>', true) );?>
		...
		<div id="WrapperServiceInvoiceCreatedBy" class="microcontroll">
		<?php	echo $this->Form->label('ServiceInvoice.created_by', __('Created By'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('ServiceInvoice.created_by',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>

		<div id="WrapperServiceInvoiceModifiedBy" class="microcontroll">
		<?php	echo $this->Form->label('ServiceInvoice.modified_by', __('Modified By'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('ServiceInvoice.modified_by',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>

	</fieldset>
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_ServiceInvoice_edit'));?>
