...
<?php echo $this->Html->css(array('common/grid','module/ServiceDeviceInfos/technician_complete'));?>
...
<?php
    $purchaseDate = '';
	$i = 0;
	foreach ($technician_completes as $technician_complete):
	...
	//pr($assessment_list);
		...
		$dataDate = date('d / m / Y',strtotime($technician_complete['ServiceDeviceInfo']['created']));
			if($purchaseDate == "" ||  $dataDate!= $purchaseDate){
				echo "<tr><td colspan = '10' class = 'listDateHeading'>".$dataDate."</td></tr>";
				$purchaseDate = $dataDate;
			}
	?>
	<tr id='<?php echo 'row_'.$technician_complete['ServiceDeviceInfo']['id'];?>'  <?php echo $class;?>>
		
         
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $technician_complete['ServiceDeviceInfo']['recive_date']; ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $technician_complete['ServiceDeviceInfo']['estimated_date']; ?>&nbsp;</div></td>
        <td align='left'>
        <div style='width: 90px;' class='alistname'><?php 
		 if($technician_complete['ServiceDeviceInfo']['status']==1){

            echo "<div class='link_view' id='Receive'>Receive</div>"; 
		
          }else if($technician_complete['ServiceDeviceInfo']['status']==2 ){
		
		    echo "<div class='link_view' id='wait_approve'>Assessment</div>"; 
		  }else if($technician_complete['ServiceDeviceInfo']['status']==3 ){
		
		    echo "<div class='link_view' id='reassessment'>Re-Assessment</div>"; 
		  }else if($technician_complete['ServiceDeviceInfo']['status']==4 ){
		
		    echo "<div class='link_view' id='Approved'>Confirmation</div>"; 
		  }else if($technician_complete['ServiceDeviceInfo']['status']==5 ){
		
		    echo "<div class='link_view' id='servicing'>Servicing</div>"; 
		  }
		   else if($technician_complete['ServiceDeviceInfo']['status']==6 ){
		
		    echo "<div class='link_view' id='s_complete'>Service Complete</div>"; 
		  }
		  else if($technician_complete['ServiceDeviceInfo']['status']==7 ){
		
		    echo "<div class='link_view'>Testing</div>"; 
		  }
		  else if($technician_complete['ServiceDeviceInfo']['status']==8 ){
		
		    echo "<div class='link_view'>Wait for delivery</div>"; 
		  }
		  else if($technician_complete['ServiceDeviceInfo']['status']==9 ){
		...
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $technician_complete['PosCustomer']['name']; ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $technician_complete['ServiceDevice']['name']; ?>&nbsp;</div></td>
        <td align='left'><div style='width: 100px;' class='alistname'><?php echo $technician_complete['ServiceDeviceInfo']['serial_no']; ?>&nbsp;</div></td>
        <td align='left'><div style='width: 60px;' class='alistname'><?php echo $technician_complete['ServiceInvoice']['inventory_total']; ?>&nbsp;</div></td>
        <td align='left'><div style='width: 60px;' class='alistname'><?php echo $technician_complete['ServiceInvoice']['service_total']; ?>&nbsp;</div></td>
