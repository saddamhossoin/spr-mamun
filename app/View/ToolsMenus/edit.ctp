...
<?php echo $this->Form->create('ToolsMenu');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperToolsMenuId" class="microcontroll">
 		<?php	echo $this->Form->input('ToolsMenu.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_ToolsMenu_edit'));?>
