<?php    //pr($purchase['PosSupplier']['PosSupplierLedger'] );?>
...
<h2 class="customer_heading">Supplier Info</h2>
 ...
 <table width="700" border="0"   class="product_table" cellspacing="0" cellpadding="0">
          <tbody>
            ...
            <tr>
              <td height="20" class="captionBorder" >&nbsp;<b>Invoice Date</b></td>
              <td height="20" class="captionBorder" > &nbsp;<b>Invoice ID</b></td>
              <td height="20" class="captionBorder" >&nbsp;<b>Payment method</b></td>
             </tr>
             <tr>
             <td height="20" class="captionBorder" >&nbsp;<span><?php echo date("j-n-Y H:i",strtotime($purchase['PosPurchase']['created']));?></span></td>
              ...
              <td height="20" class="captionBorder" >&nbsp;<span>  <?php  echo $accountsheads[$purchase['PosSupplier']['PosSupplierLedger'][0]['account_head_id']];?></span></td>
              </tr>
            </tbody>
 </table>
...
<tr>
<th class="total_price"  width="60" colspan="4">Transport =</th>
<th class="numeric"  width="60">
 <?php 	echo  $purchase['PosPurchase']['transport'];?> 
...
<tr>
<th class="total_price"  width="60" colspan="4">Others =</th>
<th class="numeric"  width="60">
 <?php echo  $purchase['PosPurchase']['others_fee'];?> 
        
        </th>
</tr>
<tr>
<th class="total_price"  width="60" colspan="4">Payable =</th>
<th class="numeric"  width="60">
 <?php echo $purchase['PosPurchase']['payable_amount'];?></th>
</tr>
<tr>
...
.customer_right_div p , .customer_info_p p{
