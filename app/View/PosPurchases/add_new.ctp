...
<div id="columns">
    <div id="PatientDetailsbox" class="widget color-blue" style="width:48%;">
        ...
        <div class="widget-content" id="PatientDetailscontent">
            ...
            <div class="posPurchases form">
                <?php echo $this->Form->create('PosPurchase',array('enctype' => 'multipart/form-data','type'=>'file','id'=>'PosPurchaseAddForm'));?>
    ...
    <div id="PatientTestbox" class="widget color-blue" style="width:48%;">
        ...
        <div class="widget-content">
            <div class="PatientDetails form" id="first">
                ...
                <?php echo $this->Form->end();?>
                <div style="display: none;" class="overlaydivsmallpurchase">&nbsp;</div>

            </div>

            <div id="productstatus" class="microcontroll" id="second">
    ...
    <div id="PatientTestbox" class="widget color-blue" style="width:48%;">
        ...
        <div class="widget-content">
            ...
            <div class="PatientDetails form">
                <?php echo $this->Form->create('PosPurchaseAmount',array('id'=>'PosPurchaseAmountAddForm'));?>
                <div id="productdetails" class="microcontroll">
                    <fieldset>
            ...
            <div class="PatientDetails"> <?php //echo $this->Form->create('PosProduct');?>
                <div id="" class="microcontroll">
                    <div class="bDiv" style="height: auto;">
                        <div class="hDiv">
                            <div class="hDivBox">
                                <?php echo $this->Form->create('PosPurchaseDetail',array('id'=>'PosPurchaseDetailAddForm'));?>
