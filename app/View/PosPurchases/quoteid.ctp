        ...
        <fieldset>
         <div id="supllier" class="microcontroll">
          <div id="first" class="microcontroll">
            <div id="WrapperPosPurchaseID" class="microcontroll"> <?php echo $this->Form->label('PosPurchase.id', __('Purchase ID :'.'', true) ); ?> <span class="id_display"> <?php echo $purchaseid[0]['id']+1;?></span> </div>
            
            <div id="WrapperPosQuoteId" class="microcontroll"> <?php echo $this->Form->label('PosPurchase.pos_quote_id', __('Quotation No'.': <span class="star"></span>', true) ); ?>
              <?php
 		echo $this->Form->select('PosPurchase.pos_quote_id',  $QuotationPurchaselists,array('div'=>false,'label'=>false, 'empty'=>'--Select Quotation No --', 'class'=>''));?>
            </div>
            ...
            <div id="WrapperPosPurchasePName" class="microcontroll"> <?php echo $this->Form->label('PosPurchase.pos_supplier_id', __('Supplier Name'.': <span class="star">*</span>', true) ); ?>
              <?php
 		echo $this->Form->select('PosPurchase.pos_supplier_id',  $posSuppliers  ,array('div'=>false,'label'=>false, 'empty'=>'-- Please Select Supplier-', 'class'=>'required'));?>
            </div>
            <div id="WrapperPosPurchasePurchaseDate" class="microcontroll"> <?php echo $this->Form->label('PosPurchase.purchase_date', __('Purchase Date'.': <span class="star">*</span>', true) ); ?> <?php echo $this->Form->input('PosPurchase.purchase_date',array('type'=>'text','div'=>false,'label'=>false, 'size'=>26, 'class'=>'required ' ));?> </div>
          </div>
        </div>
        </fieldset>
    ...
    <div class="widget-content">
      ...
      <?php echo $this->Form->create('ProductEntry');?>
        <div id="productdetails" class="microcontroll">
          ...
          <?php echo $this->Form->label('PosProduct.pos_brand_id', __('Product Brand'.': <span class="star">*</span>', true) ); ?> <?php echo $this->Form->select('PosProduct.pos_brand_id',  $brand  ,array('div'=>false,'label'=>false, 'empty'=>'-Please Select Brand-', 'class'=>'required'));?> </div>
            <div id="WrapperPosProductPosPcategoryId" class="microcontroll"> 
		 <?php echo $this->Form->label('PosProduct.pos_brand_id', __('Product Category'.': <span class="star">*</span>', true) ); ?> <?php echo $this->Form->select('PosProduct.pos_pcategory_id',  $category  ,array('div'=>false,'label'=>false, 'empty'=>'-Please Select Category-', 'class'=>'required'));?> </div>
		 ...
		 <?php echo $this->Form->label('PosProduct.pname', __('Product Name'.': <span class="star">*</span>', true) ); ?>
              <?php  echo $this->Form->select('PosProduct.name', null ,array('escape' => false,'empty'=>'-Please Select Product-', 'class'=>'required'))?>
            </div>
      ...
      <div class="PatientDetails form">
        ...
        <div id="productdetails" class="microcontroll">
          <fieldset>
            ...
            <div id="WrapperProductTotalprices" class="microcontroll"> <?php echo $this->Form->label('PosPurchaseAmount.totalprice', __('Total  Prices :'.'<span class="star"></span>', true) ); ?> <?php echo $this->Form->input('PosPurchaseAmount.totalprice',array('div'=>false,'label'=>false,   'class'=>'required','readonly'=>'readonly'));?> <span  class="accounts">
              <?php //echo $suppliers['PosSupplier']['mobile'];?>
              </span> </div>
            <div id="WrapperPosPurchasemobile" class="microcontroll"> <?php echo $this->Form->label('PosPurchaseAmount.payamount', __('Pay Amount :'.'<span class="star"></span>  ', true) ); ?> <?php echo $this->Form->input('PosPurchaseAmount.payamount',array('div'=>false,'label'=>false, 'empty'=>'-- Please Select Supplier-', 'class'=>'required'));?> </div>
          </div>
          </fieldset>
        </div>
        <?php echo $this->Form->end();?>
            ...
            <div class="hDiv">
              <div class="hDivBox">
                ...
                <table class="pdetail">
                  ...
                  <?php $sl=1; ?> 
                    <?php
					//pr($PosQuotationPurchase);
					 foreach($PosQuotationPurchase['PosQuotationPurchaseDetail'] as  $pddata){ ?>
