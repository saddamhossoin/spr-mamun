                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h4 class="h4"> Registration confirm message.</h4>
                                                              <p>Dear admin, <br><?php echo $userinfo_array['User']['firstname'];?> is registration successfully.</p>
...
<p><strong>Please check if your necessary.! </strong></p>
