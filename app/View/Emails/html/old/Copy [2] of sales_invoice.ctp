        	...
        	<table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable" style="background:#F2f2f2; border:1px solid #CCCCCC;">
            	<tr>
                	<td align="center" valign="top" style="padding-top:20px;">
                    	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateContainer" style="background:#ffffff;">
                        	<tr>
                            	<td align="center" valign="top">
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            ...
                                            <div style="font-size:30px; float:right ;color:#336699; padding:15px; text-decoration:underline;"> <?php echo $this->Html->image("/solutionpointroma.org/app/webroot/img/wpage/spr/logo.png", array("class"=>"logo","alt" => "" ,"width"=>"240","height"=>"80","border"=>"0"));?> </div>
