...
<?php echo $this->Form->create('ServiceDeviceLog');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperServiceDeviceLogId" class="microcontroll">
		<?php	echo $this->Form->label('ServiceDeviceLog.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('ServiceDeviceLog.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_ServiceDeviceLog_edit'));?>
