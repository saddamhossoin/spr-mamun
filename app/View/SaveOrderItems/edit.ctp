...
<?php echo $this->Form->create('SaveOrderItem');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperSaveOrderItemId" class="microcontroll">
		<?php	echo $this->Form->label('SaveOrderItem.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('SaveOrderItem.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_SaveOrderItem_edit'));?>
