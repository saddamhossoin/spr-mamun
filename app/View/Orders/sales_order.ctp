...
<div class="flexigrid" style="width: 100%;">
	...
	<div class="tDiv">
		<div class="tDiv2">
			<?php echo $this->Form->create('Order',array('controller' => 'Orders','action'=>'sales_order' ));?>
			...
			<div class="button_area_filter">
				...
				<?php echo $this->Form->button('Reset',array('type'=>'reset','name'=>'reset','id'=>'Cancel', 'onClick'=>"parent.location='".$this->webroot."Orders/sales_order/yes'"));?>     
			</div>
		</form>
	</div>
                ...
                <table cellspacing="0" cellpadding="0">
                    <thead>
                        <tr>
                            ...
                            <th align="left" width="13%"><?php echo $this->Paginator->sort('phone');?></td>
                    ...
                    foreach ($order_lists  as $order_list){
						...
						?>
                         <tr id='<?php echo 'row_'.$order_list['Order']['id'];?>' <?php echo $class;?>  <?php if($order_list['Order']['status'] ==3){ ?>style="display:none"<?php }?>>
                            ...
                            <?php echo $this->Html->link(__('Invoice', true), array('action' => 'sales_invoice',$order_list['Order']['id']),array('class'=>'link_view action_link')); ?>
