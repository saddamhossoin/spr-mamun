...
<br />
  ...
  <div id="PatientDetailsbox" class="widget color-blue" style="width:28%;" >
    ...
    <?php echo $this->Form->input('Order.totalamount',array('type'=>'text','div'=>false,'label'=>false, 'size'=>26, 'class'=>'required two_digit'));?> 
     </div>
        ...
        <div id="WrapperServiceInvoiceVat" class="microcontroll">
	     ...
	     <?php echo $this->Form->input('Order.tax',array('readonly'=>'readonly','div'=>false,'label'=>false,'class'=>'number two_digit'));?>
    ...
    <?php echo $this->Form->input('Order.discount',array('type'=>'text','div'=>false,'label'=>false, 'size'=>26, 'class'=>'required two_digit'));?> 
     </div>
    ...
    <?php echo $this->Form->input('Order.payable_amount',array('type'=>'text','div'=>false,'label'=>false, 'size'=>26, 'class'=>'required two_digit'));?> 
     </div>
    ...
    <?php echo $this->Form->input('Order.payamount',array('type'=>'text','div'=>false,'label'=>false, 'size'=>26, 'class'=>'required two_digit'));?> 
