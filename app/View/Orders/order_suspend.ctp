...
<div class="flexigrid" style="width: 100%;">
	...
	<div class="tDiv">
		<div class="tDiv2">
			<?php echo $this->Form->create('Order',array('controller' => 'Orders','action'=>'order_suspend' ));?>
			...
			<div class="button_area_filter">
				...
				<?php echo $this->Form->button('Reset',array('type'=>'reset','name'=>'reset','id'=>'Cancel', 'onClick'=>"parent.location='".$this->webroot."Orders/order_suspend/yes'"));?>     
			</div>
		</form>
	</div>
                         ...
                         <tr id='<?php echo 'row_'.$order_list['Order']['id'];?>' <?php echo $class;?> >
                            ...
                            <td align='left' class='alistname' width="10%"> <?php echo $order_list['Order']['total'];?>&nbsp; </td>
                                 <td class="actions" width="12%" class='alistname link_link'>
                                        ...
                                        <?php echo $this->Html->link(__('Sales Order', true), array('controller'=>'Orders','action' => 'complete_order', $order_list['Order']['id']),array('class'=>'action_link')); ?>
                                        <?php //echo $this->Html->link(__('Suspend Order', true), array('controller'=>'Orders','action'=>'suspend_order',$order_list['Order']['id']),array('class'=>'action_link suspend')); ?>
