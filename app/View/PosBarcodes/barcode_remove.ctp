...
<?php echo $this->Form->input('PosBarcode.pos_purchase_detail_id',array('type'=>'hidden','value'=>$purchase_detail_id,'div'=>false,'label'=>false,'class'=>'')); 
...
<div class="hDiv">
 ...
 <table cellspacing="0" cellpadding="0" border="0" style="" class="flexme3">
      <tbody id="PosProductGrid">
  		 <?php	 echo  $this->requestAction("PosBarcodes/ProductBaseBarcodeRemove/yes/".$purchase_detail_id, array("return"));?>
	  </tbody>
     </table>
    </div>
