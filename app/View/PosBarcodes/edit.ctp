...
<?php echo $this->Form->create('PosBarcode');?>
	<fieldset>
		...
		<?php	echo $this->Form->label('PosBarcode.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('PosBarcode.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
