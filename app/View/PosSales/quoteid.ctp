        ...
        <fieldset>
         <div id="supllier" class="microcontroll">
          <div id="first" class="microcontroll">
            <div id="WrapperPosSaleID" class="microcontroll"> <?php echo $this->Form->label('PosSale.pos_product_id', __('Sale ID :'.'', true) ); ?> <span class="id_display"> <?php echo $saleid[0]['id']+1;?></span> </div>
            
            <?php //pr($QuotationSalelist[$PosQuotationSale['PosQuotationSale']['id']]); ?>
            <div id="WrapperPosQuoteId" class="microcontroll"> <?php echo $this->Form->label('PosSale.pos_quote_id', __('Quotation No'.': <span class="star"></span>', true) ); ?>
              <?php
	 	echo $this->Form->select('PosSale.pos_quote_id',  $QuotationSalelist,array('value'=>$PosQuotationSale['PosQuotationSale']['id'],'div'=>false,'label'=>false, 'empty'=>'--Select Quotation No --', 'class'=>'select2as'));?>
            </div>
            ...
            <div id="WrapperPosSalePName" class="microcontroll"> <?php echo $this->Form->label('PosSale.pos_customer_id', __('Customer Name'.': <span class="star">*</span>', true) ); ?>
              <?php
 		echo $this->Form->select('PosSale.pos_customer_id', $poscustomers,array('value'=>$PosQuotationSale['PosQuotationSale']['pos_customer_id'],'div'=>false,'label'=>false, 'empty'=>'-- Please Select Supplier-', 'class'=>'required select2as'));?>
            </div>
            <div id="WrapperPosSalePurchaseDate" class="microcontroll">
             <?php echo $this->Form->label('PosSale.purchase_date', __('Purchase Date'.': <span class="star">*</span>', true) ); ?> 
			 <?php echo $this->Form->input('PosSale.purchase_date',array('value'=>$PosQuotationSale['PosQuotationSale']['purchase_date'],'type'=>'text','div'=>false,'label'=>false, 'size'=>26, 'class'=>'required ' ));?> </div>
          </div>
        </div>
        </fieldset>
  ...
  <div id="PatientTestbox" class="widget color-blue">
    ...
    <div class="widget-content" style="height:81px;">
      <div id="second" class="microcontroll">
       	  <?php 
		 echo  $this->requestAction("pos_sales/getcustomer/".$PosQuotationSale['PosQuotationSale']['pos_customer_id'], array("return")); ?>
	    </div>
    </div>
  </div>
    ...
    <div class="widget-content">
      ...
      <?php echo $this->Form->create('ProductEntry');?>
        <div id="productdetails" class="microcontroll">
          ...
          <?php echo $this->Form->label('PosProduct.pos_brand_id', __('Product Brand'.': <span class="star">*</span>', true) ); ?> <?php echo $this->Form->select('PosProduct.pos_brand_id',  $brand  ,array('div'=>false,'label'=>false, 'empty'=>'-Please Select Brand-', 'class'=>'required select2as'));
		    ?> </div>
      ...
      <div class="PatientDetails form">
        ...
        <div id="productdetails" class="microcontroll">
          <fieldset>
            ...
            <div id="WrapperProductTotalprices" class="microcontroll"> <?php echo $this->Form->label('PosSaleAmount.totalprice', __('Total  Prices :'.'<span class="star"></span>', true) ); ?> <?php echo $this->Form->input('PosSaleAmount.totalprice',array('value'=>$PosQuotationSale['PosQuotationSale']['totalprice'],'div'=>false,'label'=>false,   'class'=>'required','readonly'=>'readonly'));?> <span  class="accounts">
              <?php //echo $suppliers['PosSupplier']['mobile'];?>
              </span> </div>
            <div id="WrapperPosSalemobile" class="microcontroll"> <?php echo $this->Form->label('PosSaleAmount.payamount', __('Pay Amount :'.'<span class="star"></span>  ', true) ); ?> <?php echo $this->Form->input('PosSaleAmount.payamount',array('div'=>false,'label'=>false, 'empty'=>'-- Please Select Supplier-', 'class'=>'required'));?> </div>
          </div>
          </fieldset>
        </div>
        <?php echo $this->Form->end();?>
            ...
            <div class="hDiv">
              <div class="hDivBox">
                ...
                <table class="pdetail">
                  ...
                  <?php $sl=1; ?> 
                    <?php foreach($PosQuotationSale['PosQuotationSaleDetail'] as  $pddata){ ?>
