...
<?php	echo $this->Form->input('ServiceDevice.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
 	<fieldset>
		<legend> </legend>
		...
		<?php	echo $this->Form->label('ServiceDevice.pos_brand_id', __('Brand '.':<span class=star>*</span>', true) );?>
            ...
            <?php /*?><div class="button_area" id="addNewDeviceButton">
        <?php echo $this->Form->button('+ Brand',array('type'=>'button','name'=>'addNewDevice','id'=>'addNewBrand'));?></div><?php */?>
		</div>
        ...
        <?php /*?><div class="button_area" id="addNewDeviceButton">
        <?php echo $this->Form->button('+ Category',array('type'=>'button','name'=>'addNewDevice','id'=>'addNewCategory'));?></div><?php */?>
		 </div>
...
<div class="button_area">
		<?php echo $this->Form->button('Update',array( 'class'=>'submit', 'id'=>'btn_ServiceDevice_edit'));?>
