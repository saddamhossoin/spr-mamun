...
?>
	...
	<div id="WrapperMenuMenuType" class="microcontroll">
			<?php echo $this->Form->label('Menu.menu_type', __('Menu Type'.': <span class="star">*</span>', true) ); ?>
 			<?php echo $this->Form->select('Menu.menu_type',$menutype,array( 'div'=>false,'label'=>false,   'class'=>'required' ,'empty'=>'Please Select One'));?>
	...
	<div id="WrapperMenuName" class="microcontroll">
		...
		<div id="reportmenuextrat" style="display:none">
		<div id="WrapperUserJoindate" class="microcontroll" >
			<?php echo $this->Form->label('Group.group_id', __('Select Group'.': <span class="star">*</span>', true) ); ?>
 			<?php echo $this->Form->select('Group.group_id',  $grouplist  ,array('div'=>false,'label'=>false, 'multiple'=>'multiple','empty'=>'-- Please Select Group --', 'class'=>'required'));?>
 	 	</div>
