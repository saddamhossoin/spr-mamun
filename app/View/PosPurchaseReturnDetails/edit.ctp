...
<?php echo $this->Form->create('PosPurchaseReturnDetail');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperPosPurchaseReturnDetailId" class="microcontroll">
		<?php	echo $this->Form->label('PosPurchaseReturnDetail.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('PosPurchaseReturnDetail.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_PosPurchaseReturnDetail_edit'));?>
