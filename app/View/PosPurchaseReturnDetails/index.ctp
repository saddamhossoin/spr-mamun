...
<div class="tDiv">
  <div class="tDiv2">
   <?php echo $this->Form->create('PosPurchaseReturnDetail',array('controller' => 'posPurchaseReturnDetails','action'=>'index' ));?>
   <?php echo $this->element('filter/commonfilter',array('cache' => array('time'=> '-7 days','key'=>'header')));?>
    <div class="button_area_filter">
     
      <?php echo $this->Form->button('Search',array( 'class'=>'submit', 'id'=>'btn_brand_search'));?>      <?php echo $this->Form->button('Reset',array('type'=>'reset','name'=>'reset','id'=>'Cancel', 'onClick'=>"parent.location='posPurchaseReturnDetails/index/yes'"));?>     
    </div>
    </form>
  </div>
    ...
    <table cellspacing="0" cellpadding="0">
      <thead>
        <tr>
			...
			<th align="left" ><div style=" width: 100px;"><?php echo $this->Paginator->sort('pos_purchase_return_id');?></div></th>
...
<?php
	$i = 0;
	foreach ($posPurchaseReturnDetails as $posPurchaseReturnDetail):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr id='<?php echo 'row_'.$posPurchaseReturnDetail['PosPurchaseReturnDetail']['id'];?>'  <?php echo $class;?>>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $posPurchaseReturnDetail['PosPurchaseReturnDetail']['id']; ?>&nbsp;</div></td>
		...
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $posPurchaseReturnDetail['PosPurchaseReturnDetail']['quantity']; ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $posPurchaseReturnDetail['PosPurchaseReturnDetail']['price']; ?>&nbsp;</div></td>
		<td align='left'><div style='width: 100px;' class='alistname'><?php echo $posPurchaseReturnDetail['PosPurchaseReturnDetail']['created']; ?>&nbsp;</div></td>
		<td class="actions">
<div style='width: 180px;' class='alistname link_link'>			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $posPurchaseReturnDetail['PosPurchaseReturnDetail']['id']),array('class'=>'link_view action_link')); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $posPurchaseReturnDetail['PosPurchaseReturnDetail']['id']),array('class'=>'link_edit action_link')); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $posPurchaseReturnDetail['PosPurchaseReturnDetail']['id']), array('class'=>'link_delete action_link'), sprintf(__('Are you sure you want to delete # %s?', true), $posPurchaseReturnDetail['PosPurchaseReturnDetail']['id'])); ?>
		</div></td>
	</tr>
<?php endforeach; ?>
    </table>
    ...
    <div class="pDiv">
    <div class="pGroup">
     	 <?php if($this->params['paging']['PosPurchaseReturnDetail']['prevPage']){?>
      ...
      <?php if($this->params['paging']['PosPurchaseReturnDetail']['nextPage']){?>
