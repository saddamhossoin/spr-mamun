...
<?php echo $this->Form->create('Color');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperColorId" class="microcontroll">
		 <?php	echo $this->Form->input('Color.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_Color_edit'));?>
