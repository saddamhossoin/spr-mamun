...
<?php echo $this->Html->css(array('module/Assesments/add','common/grid')); ?>
<?php echo $this->Html->script(array('module/Assesments/deliveryview_assessment')); ?>
 	<div class="button_area">
		
 		<?php if($serviceDeviceInfo['ServiceDeviceInfo']['status']==7){?>
		 
		<?php } else if($serviceDeviceInfo['ServiceDeviceInfo']['status']==8){?>
	 
		<?php }?>
        
     <?php echo $this->Html->link("Complete", array('action'=> 'assessment_delivered', $serviceDeviceInfo['ServiceDeviceInfo']['id']), array( 'class' => 'action_link specialLink','id'=>$serviceDeviceInfo['ServiceDeviceInfo']['id']));?>
