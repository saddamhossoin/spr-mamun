...
<?php echo $this->Form->create('PosPurchaseDetail');?>
	<fieldset>
		<legend> </legend>
		<div id="WrapperPosPurchaseDetailId" class="microcontroll">
		<?php	echo $this->Form->label('PosPurchaseDetail.id', __('Id'.':<span class=star>*</span>', true) );?>
		<?php	echo $this->Form->input('PosPurchaseDetail.id',array('div'=>false,'label'=>false,'class'=>'required'));?>
		</div>
...
<div class="button_area">
		<?php echo $this->Form->button('Save',array( 'class'=>'submit', 'id'=>'btn_PosPurchaseDetail_edit'));?>
