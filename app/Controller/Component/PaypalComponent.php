...
class PaypalComponent extends Component {  
	...
	public $config = array(
		...
		'password' => '1369663200',
		'email' => 'paypal-facilitator_api1.ict-consultants.com',
		'signature' => 'At3PgWSVn4haLf..uu8-PdPFLBoNAS0tdHvMgU1Qw2M488Lbl1cjoMpC'
	);
	...
	public function expressCheckout() {
		//pr($this->config['webscr'].'?cmd=_express-checkout&token='.$token['TOKEN']);die();
	...
	public function setExpressCheckout() {
		...
		$setExpressCheckoutNvp = array_merge((array)$orderbas, (array)$itemdetails);
