$(document).ready(function(){
	...
	$(".remove").each(function() {
		$(this).replaceWith('<a class="remove" id="' + $(this).attr('id') + '" href="' + siteurl + 'shop/remove/' + $(this).attr('id') + '" title="Remove item"><img src="' + siteurl + 'img/icon-remove.gif" alt="Remove" /></a>');
	});
